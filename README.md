...
7. Initialize a variable named `codeB` to have the value `10-40-39`. The value must be a single [template literal](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals).
